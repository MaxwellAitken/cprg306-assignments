...
export default function ItemList({items, onItemSelect}) {
    ...
    //Styles 
    let buttonStyle = "  h-10 px-3 py-2 rounded-lg bg-gray-800 drop-shadow-2xl shadow-gray-800 text-sm whitespace-nowrap ";
    let inactiveStyle = " cursor-pointer bg-gray-800 hover:bg-gray-700 ";
    let activeStyle = " cursor-default text-gray-300 border-solid border-2 border-gray-600 bg-zinc-800 ";
